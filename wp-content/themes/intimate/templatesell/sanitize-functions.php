 ...
 */
function intimate_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function intimate_sanitize_select( $input, $setting ) {
 ...
 *                    the setting default.
 */
function intimate_sanitize_number_range( $number, $setting ) {
 ...
 *  @since Springy 1.0.0
 */
if (!function_exists('intimate_sanitize_number')) :
    function intimate_sanitize_number($input)
    {
 ...
 *
 */
if ( !function_exists('intimate_sanitize_image') ) :
	function intimate_sanitize_image( $image, $setting ) {
		/*
